 ...
 * @param $p_project_id int Project id
 * @param $p_date_from string Start date
 * @param $p_date_to string End date
...
function activity_get_latest_bugnotes( $p_project_id, $p_date_from, $p_date_to, $p_limit = 500 ) {
    ...
    $t_query = "SELECT b.*, t.note
                    ...
                    WHERE bt.project_id=" . db_param() . " AND b.date_submitted >= $c_from AND b.date_submitted <= $c_to".
